...
var app = angular.module('sampleapp', ['ngAnimate', 'ngMaterial', 'ngMdIcons', 'abl-payment-summary']);
...
app.controller('SampleController', ['$scope', '$mdMedia', '$rootScope', '$window', '$timeout', function($scope, $mdMedia, $rootScope, $window, $timeout) {
  ...
  $scope.paymentResponse = 'completed';
  $scope.$on('pay', function(e, a) {
    console.log('received pay emit', a);
    $scope.bookingResponse = a;
    $scope.bookingResponse.paymentResponse = $scope.paymentResponse;
    $timeout(function() {
      $scope.$broadcast('paymentResponse', $scope.bookingResponse);
    }, 2500);
  });
  ...
  $scope.unit = {
    ...
    "property": {
      ...
      "location": {
        ...
        "searchTerms": [],
        "location": {
          "coordinates": [-149.86827850341797, -17.556778881539657],
          "type": "Point"
        },
        "zoom": 15,
        "streetAddress2": "",
  ...
  $scope.activities = [{
      ...
      "operator": {
        ...
        "location": {
          ...
          "zipCode": "S4S 4P6",
          "location": {
            "coordinates": [-104.60575799999998,
              50.4153189
            ],
            "type": "Point"
          },
